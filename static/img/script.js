$(document).ready(function() {
 ...
 /* Adding Sticky Navigation */
 $(".js--signup-section").waypoint(function(direction) {
  if(direction=="down") {
    $("nav").addClass('sticky-nav');
  }
  else {
 ...
 $(".js--scroll-to-signup").click(function() {
  ...
  $(".js--login-section").waypoint(function(direction) {
		$(".js--login-box").addClass('animate__animated animate__fadeIn');
	}, {
		offset:'50%'
	}); 
